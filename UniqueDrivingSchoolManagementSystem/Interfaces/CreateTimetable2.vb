Public Class CreateTimetable2
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        If tbInstructorID.Text <> "" Then
            ...
            If Ist3bbDataSet4.Booking.Rows(0).Item("LessonDate") IsNot DBNull.Value Then
                ...
                If Ist3bbDataSet4.Booking.Rows(0).Item("LessonDate") > Date.Now Then
                ...
                Else
                    MessageBox.Show("The selected lesson number date has passed and cannot be changed, " + Environment.NewLine + " Please Choose another lesson number with a date that has not passed")
    ...
    Private Sub CreateTimetable_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Me.CustomerTableAdapter.FillByCustomerID(Ist3bbDataSet1.Customer, Integer.Parse(CustomerBooking.tbCustomerID1.Text))
            TextBox1.Text = Integer.Parse(CustomerBooking.tbCustomerID1.Text)
            TextBox1.SelectedValue = Integer.Parse(CustomerBooking.tbCustomerID1.Text)
